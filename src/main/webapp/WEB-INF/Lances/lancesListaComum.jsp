...
<head>
  ...
  <style><%@include file="/WEB-INF/Lances/estiloComum.css"%></style>
...
<table id="minhaTabela">
  ...
  <c:forEach items="${lances}" var="l">
    <tr>
      ...
      <td><a href="entrada?acao=buscarLancesID&IDLance=${l.id}" id="editar">Lance <img src = "${pageContext.request.contextPath}/images/editlogo.png"></a></td>
    </tr>
  </c:forEach>
